...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <a class="nav-link dropdown-toggle" href="{{ route('login') }}" id="loginDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Login
                        </a>
                            <ul class="dropdown-menu" aria-labelledby="loginDropdown">
                                <li><a class="dropdown-item" href="{{route('loginstudent')}}">Login As Student</a></li>
                                <li><a class="dropdown-item" href="{{route('loginalumini')}}">Login As Alumini</a></li>
                                <li><a class="dropdown-item" href="{{route('logincompany')}}">Login As Company</a></li>
                            </ul>
                        </li>
        ...
        <header class="bg-primary bg-gradient text-white">
            <div class="container px-4 text-center">
                ...
                <a class="btn btn-lg btn-light" href="{{route('signup')}}">Get Started!</a>
            </div>
        </header>
        <!-- About section-->
        <section id="about">
            ...
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        @endif
                        <div class="form-box" style="color">
                            <form action="{{route('contact.submit')}}" method="POST">
                                ...
                                <textarea name="message" class="form-control" name="message" id="message" cols="10" rows="10" placeholder="Enter Your Meaasge"></textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        required
                                    >
                                    <div id="phoneHelp" class="form-text">Enter your number in the format: +91 xxxxx xxxxx</div>
                                </div>
        ...
        <footer id="footer" class="footer-1">
                    ...
                    <p><a href="mailto:priyanshujash27@gmail.com" title="glorythemes">info@domain.com</a></p>
